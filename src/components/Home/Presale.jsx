...
const Presale = () => {
  ...
  return (
    <div id='presale' className="py-20 bg-secondary text-tertiary flex items-center justify-center p-6 font-sans">
      <div className="relative w-full max-w-4xl bg-tertiary/5 backdrop-blur-xl border border-tertiary/10 rounded-3xl px-8 py-12 shadow-2xl">
        ...
        <div className="mb-8">
          ...
          <div className="w-full bg-tertiary/10 h-3 rounded-full overflow-hidden">
            <div className="bg-gradient-to-r from-primary/80 to-primary/60 h-full w-[65%] rounded-full shadow-[0_0_15px_rgba(168,85,247,0.5)]"></div>
          </div>
        </div>

        {/* Input Section */}
        <div className="space-y-4 flex md:flex-row flex-col items-start gap-2">
          <div className="w-full bg-tertiary/5 border border-tertiary/10 rounded-2xl p-4 transition-all focus-within:border-purple-500/50">
          ...
          <div className="flex md:h-20 md:w-auto w-full items-center justify-center absolute top-[36%] left-0 md:relative">
            <div className="bg-[#1e293b] h-10 border border-tertiary/10 p-2 rounded-full shadow-lg">
              <ArrowRight size={20} className="text-purple-400" />
            </div>
          </div>

          <div className="w-full bg-tertiary/5 border border-tertiary/10 rounded-2xl p-4">
            <div className="flex justify-between text-xs text-gray-400 mb-2">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                placeholder="0"
              />
              <div className="flex items-center gap-2 bg-tertiary/10 px-3 py-1.5 rounded-xl border border-purple-500/30">
        ...
        <div className="mt-8 space-y-3 bg-secondary/20 rounded-2xl p-4 text-sm border border-tertiary/5">
          <div className="flex justify-between text-gray-400">
            <span>Price</span>
            <span className="text-tertiary">1 LX = $0.015</span>
          </div>
          <div className="flex justify-between text-gray-400">
            <span>Exchange Rate</span>
            <span className="text-tertiary">1 SOL ≈ 2,900 LX</span>
          </div>
          <div className="flex justify-between text-gray-400">
            <span>Slippage</span>
        ...
        {/* Action Button */}
        <button 
            className="cursor-pointer w-full mt-8 bg-tertiary/90 hover:bg-tertiary backdrop-blur-3xl text-secondary py-4 rounded-2xl font-bold text-lg transition-all transform active:scale-[0.98] shadow-[0_0_20px_rgba(168,85,247,0.4)] flex items-center justify-center gap-2"
